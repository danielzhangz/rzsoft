...
//     function my_get_token(){
//         $url= 'http://10.3.20.8/zabbix/api_jsonrpc.php';
//         $postdata='{"jsonrpc": "2.0","method": "user.login","params": {"user": "Admin","password": "g@6N7cSa"},"id": 1,"auth": null}';
//         $options=array('http'=>array('method'=>'POST','header'=>'content-type:application/json','content'=>$postdata,'timeout'=>15));
//         $context=stream_context_create($options);
//         $aa=file_get_contents($url,false,$context);
//         return $aa;
//     }
